<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceCalc.aspx.cs" Inherits="GF.Service.FandP.PriceCalc.PriceCalc" %>
<%
    ...
    try
    {
        ...
        xmlRequest = xmlRequest.Replace("</request>", "<affinity_no>0</affinity_no></request>");
